...
#define __PYX_HAVE__jenkspy__jenks
#define __PYX_HAVE_API__jenkspy__jenks
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "_jenks.c"
...
struct __pyx_opt_args_7jenkspy_5jenks__jenks_matrices;

/* "jenkspy/src/jenks.pyx":49
 *     return breaks
 * 
...
/* Module declarations from 'jenkspy.jenks' */
...
static PyObject *__pyx_f_7jenkspy_5jenks__jenks_breaks(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_7jenkspy_5jenks__jenks_matrices(PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7jenkspy_5jenks__jenks_matrices *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "jenkspy.jenks"
extern int __pyx_module_is_main_jenkspy__jenks;
int __pyx_module_is_main_jenkspy__jenks = 0;

/* Implementation of 'jenkspy.jenks' */
...
static const char __pyx_k_testing_algo[] = "testing_algo";
...
static const char __pyx_k_variance_combinations[] = "variance_combinations";
...
static PyObject *__pyx_n_u_lower_class_limits;
...
static PyObject *__pyx_n_s_testing_algo;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_n_s_update;
static PyObject *__pyx_n_s_values;
static PyObject *__pyx_n_u_variance_combinations;
static PyObject *__pyx_pf_7jenkspy_5jenks__jenks_breaks(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values, PyObject *__pyx_v_n_classes); /* proto */
static PyObject *__pyx_pf_7jenkspy_5jenks_2_jenks_matrices(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values, PyObject *__pyx_v_n_classes, PyObject *__pyx_v_testing_algo); /* proto */
...
static PyObject *__pyx_pw_7jenkspy_5jenks_1_jenks_breaks(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7jenkspy_5jenks__jenks_breaks(PyObject *__pyx_v_values, PyObject *__pyx_v_n_classes, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_breaks = 0;
  unsigned int __pyx_v__n_classes;
  unsigned int __pyx_v__n_breaks;
  unsigned int __pyx_v_len_values;
  CYTHON_UNUSED unsigned int __pyx_v_i;
  int *__pyx_v__lower_class_limits;
  double *__pyx_v__variance_combinations;
  unsigned int __pyx_v_m;
  unsigned int __pyx_v_jj;
  PyObject *__pyx_v_sorted_values = 0;
  __Pyx_memviewslice __pyx_v__sorted_values = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_jenks_breaks", 0);

  /* "jenkspy/src/jenks.pyx":13
 * cpdef list _jenks_breaks(values, n_classes):
 *     cdef:
 *         list breaks = []             # <<<<<<<<<<<<<<
 *         unsigned int _n_classes = <unsigned int>int(n_classes) # How many classes (clusters)
 ...
 */
  ...
  __pyx_v_breaks = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "jenkspy/src/jenks.pyx":14
 *     cdef:
 *         list breaks = []
 *         unsigned int _n_classes = <unsigned int>int(n_classes) # How many classes (clusters)             # <<<<<<<<<<<<<<
 *         unsigned int _n_breaks = <unsigned int>_n_classes + 1 # How many class boundaries
 ...
 */
  __pyx_t_1 = __Pyx_PyNumber_Int(__pyx_v_n_classes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_As_unsigned_int(__pyx_t_1); if (unlikely((__pyx_t_2 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v__n_classes = ((unsigned int)__pyx_t_2);

  /* "jenkspy/src/jenks.pyx":15
 *         list breaks = []
 *         unsigned int _n_classes = <unsigned int>int(n_classes) # How many classes (clusters)
 *         unsigned int _n_breaks = <unsigned int>_n_classes + 1 # How many class boundaries             # <<<<<<<<<<<<<<
 *         unsigned int len_values = <unsigned int>len(values) # How many values to classify
 *         unsigned int i
 */
  __pyx_v__n_breaks = (((unsigned int)__pyx_v__n_classes) + 1);

  /* "jenkspy/src/jenks.pyx":16
 *         unsigned int _n_classes = <unsigned int>int(n_classes) # How many classes (clusters)
 *         unsigned int _n_breaks = <unsigned int>_n_classes + 1 # How many class boundaries
 *         unsigned int len_values = <unsigned int>len(values) # How many values to classify             # <<<<<<<<<<<<<<
 *         unsigned int i
 ...
 */
  __pyx_t_3 = PyObject_Length(__pyx_v_values); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 16, __pyx_L1_error)
  __pyx_v_len_values = ((unsigned int)__pyx_t_3);

  /* "jenkspy/src/jenks.pyx":18
 *         unsigned int len_values = <unsigned int>len(values) # How many values to classify
 *         unsigned int i
 *         int *_lower_class_limits = <int *> malloc((len_values * _n_classes) * sizeof(int))             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v__lower_class_limits = ((int *)malloc(((__pyx_v_len_values * __pyx_v__n_classes) * (sizeof(int)))));

  /* "jenkspy/src/jenks.pyx":19
 *         unsigned int i
 *         int *_lower_class_limits = <int *> malloc((len_values * _n_classes) * sizeof(int))
 *         double *_variance_combinations = <double *> malloc((len_values * _n_classes) * sizeof(double))             # <<<<<<<<<<<<<<
 *         unsigned int m, k, jj # Indexes for fetching break values from _lower_class_limits matrix
 ...
 */
  __pyx_v__variance_combinations = ((double *)malloc(((__pyx_v_len_values * __pyx_v__n_classes) * (sizeof(double)))));

  /* "jenkspy/src/jenks.pyx":21
 *         double *_variance_combinations = <double *> malloc((len_values * _n_classes) * sizeof(double))
 *         unsigned int m, k, jj # Indexes for fetching break values from _lower_class_limits matrix
 *         sorted_values = np.sort(values) # Sort the values to classify             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_sort); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 21, __pyx_L1_error)
  ...
  __pyx_t_1 = (__pyx_t_4) ? __Pyx_PyObject_Call2Args(__pyx_t_5, __pyx_t_4, __pyx_v_values) : __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_v_values);
  __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_sorted_values = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "jenkspy/src/jenks.pyx":22
 *         unsigned int m, k, jj # Indexes for fetching break values from _lower_class_limits matrix
 *         sorted_values = np.sort(values) # Sort the values to classify
 *         double[:] _sorted_values = sorted_values.astype(np.float64) # Convert to double array             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_sorted_values, __pyx_n_s_astype); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float64); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 22, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v__sorted_values = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "jenkspy/src/jenks.pyx":25
 * 
 *     # Fill the lower_class_limits and variance_combinations matrices
 ...
 */
  ...
  __pyx_t_9 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_v__sorted_values.shape[0];
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_9 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_v__sorted_values.shape[0])) __pyx_t_9 = 0;
  if (unlikely(__pyx_t_9 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_9);
    __PYX_ERR(0, 25, __pyx_L1_error)
  }
  (void)(JenksMatrices(__pyx_v__variance_combinations, __pyx_v__lower_class_limits, (&(*((double *) ( /* dim=0 */ (__pyx_v__sorted_values.data + __pyx_t_8 * __pyx_v__sorted_values.strides[0]) )))), __pyx_v__n_classes, __pyx_v_len_values));

  /* "jenkspy/src/jenks.pyx":28
 * 
 *     # Fill the breaks array with minimum value of the target array
 ...
 * 
 */
  __pyx_t_2 = __pyx_v__n_breaks;
  __pyx_t_10 = __pyx_t_2;
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    __pyx_v_i = __pyx_t_11;

    /* "jenkspy/src/jenks.pyx":29
 *     # Fill the breaks array with minimum value of the target array
 *     for i in range(_n_breaks):
 *         breaks.append(sorted_values[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_sorted_values, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_12 = __Pyx_PyList_Append(__pyx_v_breaks, __pyx_t_1); if (unlikely(__pyx_t_12 == ((int)-1))) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }

  /* "jenkspy/src/jenks.pyx":32
 * 
 *     # Last break value is the maximum of the array
 ...
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_sorted_values, -1L, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (unlikely(__Pyx_SetItemInt(__pyx_v_breaks, __pyx_v__n_classes, __pyx_t_1, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 1, 0, 1) < 0)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "jenkspy/src/jenks.pyx":35
 * 
 *     # Read the class limits from the lower_class_limits matrix
 *     m = len_values             # <<<<<<<<<<<<<<
 ...
 *         jj = _n_classes - j + 1
 */
  __pyx_v_m = __pyx_v_len_values;

  /* "jenkspy/src/jenks.pyx":36
 *     # Read the class limits from the lower_class_limits matrix
 *     m = len_values
 *     for j in range(1, _n_classes):             # <<<<<<<<<<<<<<
 *         jj = _n_classes - j + 1
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v__n_classes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_5, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (likely(PyList_CheckExact(__pyx_t_1)) || PyTuple_CheckExact(__pyx_t_1)) {
    ...
    __pyx_t_3 = -1; __pyx_t_5 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_13 = Py_TYPE(__pyx_t_5)->tp_iternext; if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 36, __pyx_L1_error)
  }
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  for (;;) {
    if (likely(!__pyx_t_13)) {
      if (likely(PyList_CheckExact(__pyx_t_5))) {
        ...
        __pyx_t_1 = PyList_GET_ITEM(__pyx_t_5, __pyx_t_3); __Pyx_INCREF(__pyx_t_1); __pyx_t_3++; if (unlikely(0 < 0)) __PYX_ERR(0, 36, __pyx_L1_error)
        #else
        __pyx_t_1 = PySequence_ITEM(__pyx_t_5, __pyx_t_3); __pyx_t_3++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        #endif
      } else {
        if (__pyx_t_3 >= PyTuple_GET_SIZE(__pyx_t_5)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_5, __pyx_t_3); __Pyx_INCREF(__pyx_t_1); __pyx_t_3++; if (unlikely(0 < 0)) __PYX_ERR(0, 36, __pyx_L1_error)
        #else
        __pyx_t_1 = PySequence_ITEM(__pyx_t_5, __pyx_t_3); __pyx_t_3++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        #endif
 ...
 */
    __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v__n_classes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = PyNumber_Subtract(__pyx_t_1, __pyx_v_j); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyInt_AddObjC(__pyx_t_6, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_2 = __Pyx_PyInt_As_unsigned_int(__pyx_t_1); if (unlikely((__pyx_t_2 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_jj = __pyx_t_2;

    /* "jenkspy/src/jenks.pyx":40
 *         # Note that the indexes contained in the _lower_class_limits matrix are 1-based,
 *         # so we have to subtract 1 to get the correct index
 ...
 * 
 */
    __pyx_t_14 = ((__pyx_v__lower_class_limits[(((__pyx_v_m - 1) * __pyx_v__n_classes) + (__pyx_v_jj - 1))]) - 2);
    __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_sorted_values, __pyx_t_14, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_14 = (__pyx_v_jj - 1);
    if (unlikely(__Pyx_SetItemInt(__pyx_v_breaks, __pyx_t_14, __pyx_t_1, long, 1, __Pyx_PyInt_From_long, 1, 1, 1) < 0)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "jenkspy/src/jenks.pyx":41
 *         # so we have to subtract 1 to get the correct index
 *         breaks[jj - 1] = sorted_values[_lower_class_limits[(m - 1) * _n_classes + (jj - 1)] - 2]
 *         m = _lower_class_limits[(m - 1) * _n_classes + (jj - 1)] - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_m = ((__pyx_v__lower_class_limits[(((__pyx_v_m - 1) * __pyx_v__n_classes) + (__pyx_v_jj - 1))]) - 1);
 ...
 * 
 */
  free(((void *)__pyx_v__lower_class_limits));

  /* "jenkspy/src/jenks.pyx":45
 *     # Free memory we manually allocated
 *     free(<void *>_lower_class_limits)
 *     free(<void *>_variance_combinations)             # <<<<<<<<<<<<<<
 * 
 *     return breaks
 */
  free(((void *)__pyx_v__variance_combinations));

  /* "jenkspy/src/jenks.pyx":47
 *     free(<void *>_variance_combinations)
 * 
 *     return breaks             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("jenkspy.jenks._jenks_breaks", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_breaks);
  __Pyx_XDECREF(__pyx_v_sorted_values);
  __PYX_XDEC_MEMVIEW(&__pyx_v__sorted_values, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_7jenkspy_5jenks_1_jenks_breaks(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7jenkspy_5jenks_1_jenks_breaks(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_jenks_breaks (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_values,&__pyx_n_s_n_classes,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_classes)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_jenks_breaks", 1, 2, 2, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_jenks_breaks") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("_jenks_breaks", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("jenkspy.jenks._jenks_breaks", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7jenkspy_5jenks__jenks_breaks(__pyx_self, __pyx_v_values, __pyx_v_n_classes);
...
static PyObject *__pyx_pf_7jenkspy_5jenks__jenks_breaks(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values, PyObject *__pyx_v_n_classes) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("_jenks_breaks", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_7jenkspy_5jenks__jenks_breaks(__pyx_v_values, __pyx_v_n_classes, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_7jenkspy_5jenks_3_jenks_matrices(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7jenkspy_5jenks__jenks_matrices(PyObject *__pyx_v_values, PyObject *__pyx_v_n_classes, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_7jenkspy_5jenks__jenks_matrices *__pyx_optional_args) {
  PyObject *__pyx_v_testing_algo = ((PyObject *)Py_False);
  unsigned int __pyx_v__n_classes;
  unsigned int __pyx_v_len_values;
  unsigned int __pyx_v_i;
  int *__pyx_v__lower_class_limits;
  double *__pyx_v__variance_combinations;
  PyObject *__pyx_v_lower_class_limits = 0;
  PyObject *__pyx_v_variance_combinations = 0;
  PyObject *__pyx_v_sorted_values = 0;
  __Pyx_memviewslice __pyx_v__sorted_values = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_j = NULL;
  PyObject *__pyx_r = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_jenks_matrices", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_testing_algo = __pyx_optional_args->testing_algo;
    }
  }

  /* "jenkspy/src/jenks.pyx":51
 * cpdef dict _jenks_matrices(values, n_classes, testing_algo=False):
 *     cdef:
 *         unsigned int _n_classes = <unsigned int>int(n_classes) # How many classes (clusters)             # <<<<<<<<<<<<<<
 *         unsigned int len_values = <unsigned int>len(values) # How many values to classify
 *         unsigned int i
 */
  __pyx_t_1 = __Pyx_PyNumber_Int(__pyx_v_n_classes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_As_unsigned_int(__pyx_t_1); if (unlikely((__pyx_t_2 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v__n_classes = ((unsigned int)__pyx_t_2);

  /* "jenkspy/src/jenks.pyx":52
 *     cdef:
 *         unsigned int _n_classes = <unsigned int>int(n_classes) # How many classes (clusters)
 *         unsigned int len_values = <unsigned int>len(values) # How many values to classify             # <<<<<<<<<<<<<<
 *         unsigned int i
 *         int *_lower_class_limits = <int *> malloc((len_values * _n_classes) * sizeof(int))
 */
  __pyx_t_3 = PyObject_Length(__pyx_v_values); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 52, __pyx_L1_error)
  __pyx_v_len_values = ((unsigned int)__pyx_t_3);

  /* "jenkspy/src/jenks.pyx":54
 *         unsigned int len_values = <unsigned int>len(values) # How many values to classify
 *         unsigned int i
 *         int *_lower_class_limits = <int *> malloc((len_values * _n_classes) * sizeof(int))             # <<<<<<<<<<<<<<
 *         double *_variance_combinations = <double *> malloc((len_values * _n_classes) * sizeof(double))
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_lower_class_limits = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "jenkspy/src/jenks.pyx":58
 *         unsigned int m, k, jj # Indexes for fetching break values from _lower_class_limits matrix
 *         list lower_class_limits = []
 *         list variance_combinations = []             # <<<<<<<<<<<<<<
 *         sorted_values = np.sort(values) # Sort the values to classify
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_variance_combinations = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "jenkspy/src/jenks.pyx":59
 *         list lower_class_limits = []
 *         list variance_combinations = []
 *         sorted_values = np.sort(values) # Sort the values to classify             # <<<<<<<<<<<<<<
 *         double[:] _sorted_values = sorted_values.astype(np.float64) # Convert to double array
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_sort); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_5))) {
 ...
 *     # Fill the lower_class_limits and variance_combinations matrices
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_sorted_values, __pyx_n_s_astype); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v__sorted_values = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "jenkspy/src/jenks.pyx":63
 * 
 *     # Fill the lower_class_limits and variance_combinations matrices
 *     if not testing_algo:             # <<<<<<<<<<<<<<
 *         JenksMatrices(_variance_combinations, _lower_class_limits, &_sorted_values[0], _n_classes, len_values)
 *     else:
 */
  __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_v_testing_algo); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 63, __pyx_L1_error)
  __pyx_t_9 = ((!__pyx_t_8) != 0);
  if (__pyx_t_9) {

    /* "jenkspy/src/jenks.pyx":64
 *     # Fill the lower_class_limits and variance_combinations matrices
 *     if not testing_algo:
 *         JenksMatrices(_variance_combinations, _lower_class_limits, &_sorted_values[0], _n_classes, len_values)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v__sorted_values.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_v__sorted_values.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 64, __pyx_L1_error)
    }
    (void)(JenksMatrices(__pyx_v__variance_combinations, __pyx_v__lower_class_limits, (&(*((double *) ( /* dim=0 */ (__pyx_v__sorted_values.data + __pyx_t_10 * __pyx_v__sorted_values.strides[0]) )))), __pyx_v__n_classes, __pyx_v_len_values));
 ...
 */
  /*else*/ {
    ...
    (void)(JenksMatricesTest(__pyx_v__variance_combinations, __pyx_v__lower_class_limits, (&(*((double *) ( /* dim=0 */ (__pyx_v__sorted_values.data + __pyx_t_10 * __pyx_v__sorted_values.strides[0]) )))), __pyx_v__n_classes, __pyx_v_len_values));
  }
  __pyx_L3:;

  /* "jenkspy/src/jenks.pyx":70
 *     # Reconstruct the lower class limits matrix and the variance combinations matrix
 ...
 */
  __pyx_t_2 = __pyx_v_len_values;
  __pyx_t_12 = __pyx_t_2;
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    __pyx_v_i = __pyx_t_13;

    /* "jenkspy/src/jenks.pyx":71
 *     # from the 1D arrays that we use in C code
 *     for i in range(len_values):
 *         lower_class_limits.append([])             # <<<<<<<<<<<<<<
 *         variance_combinations.append([])
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_lower_class_limits, __pyx_t_1); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "jenkspy/src/jenks.pyx":72
 *     for i in range(len_values):
 *         lower_class_limits.append([])
 *         variance_combinations.append([])             # <<<<<<<<<<<<<<
 *         for j in range(_n_classes):
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_variance_combinations, __pyx_t_1); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 72, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "jenkspy/src/jenks.pyx":73
 *         lower_class_limits.append([])
 *         variance_combinations.append([])
 *         for j in range(_n_classes):             # <<<<<<<<<<<<<<
 *             lower_class_limits[i].append(_lower_class_limits[i * _n_classes + j])
 ...
 */
    __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v__n_classes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_builtin_range, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (likely(PyList_CheckExact(__pyx_t_5)) || PyTuple_CheckExact(__pyx_t_5)) {
      ...
      __pyx_t_3 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_15 = Py_TYPE(__pyx_t_1)->tp_iternext; if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 73, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    for (;;) {
      if (likely(!__pyx_t_15)) {
        if (likely(PyList_CheckExact(__pyx_t_1))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_5 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_3); __Pyx_INCREF(__pyx_t_5); __pyx_t_3++; if (unlikely(0 < 0)) __PYX_ERR(0, 73, __pyx_L1_error)
          #else
          __pyx_t_5 = PySequence_ITEM(__pyx_t_1, __pyx_t_3); __pyx_t_3++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          #endif
        } else {
          if (__pyx_t_3 >= PyTuple_GET_SIZE(__pyx_t_1)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_5 = PyTuple_GET_ITEM(__pyx_t_1, __pyx_t_3); __Pyx_INCREF(__pyx_t_5); __pyx_t_3++; if (unlikely(0 < 0)) __PYX_ERR(0, 73, __pyx_L1_error)
          #else
          __pyx_t_5 = PySequence_ITEM(__pyx_t_1, __pyx_t_3); __pyx_t_3++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          #endif
 ...
 * 
 */
      __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_lower_class_limits, __pyx_v_i, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 1, 0, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = __Pyx_PyInt_From_unsigned_int((__pyx_v_i * __pyx_v__n_classes)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_4 = PyNumber_Add(__pyx_t_6, __pyx_v_j); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_16 = __Pyx_PyIndex_AsSsize_t(__pyx_t_4); if (unlikely((__pyx_t_16 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyInt_From_int((__pyx_v__lower_class_limits[__pyx_t_16])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_14 = __Pyx_PyObject_Append(__pyx_t_5, __pyx_t_4); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

      /* "jenkspy/src/jenks.pyx":75
 *         for j in range(_n_classes):
 *             lower_class_limits[i].append(_lower_class_limits[i * _n_classes + j])
 *             variance_combinations[i].append(_variance_combinations[i * _n_classes + j])             # <<<<<<<<<<<<<<
 * 
 *     # Free memory we manually allocated
 */
      __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_variance_combinations, __pyx_v_i, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 1, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_PyInt_From_unsigned_int((__pyx_v_i * __pyx_v__n_classes)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_v_j); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_16 = __Pyx_PyIndex_AsSsize_t(__pyx_t_6); if (unlikely((__pyx_t_16 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyFloat_FromDouble((__pyx_v__variance_combinations[__pyx_t_16])); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_14 = __Pyx_PyObject_Append(__pyx_t_4, __pyx_t_6); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 75, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_array); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_5))) {
  ...
  __pyx_t_6 = (__pyx_t_4) ? __Pyx_PyObject_Call2Args(__pyx_t_5, __pyx_t_4, __pyx_v_lower_class_limits) : __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_v_lower_class_limits);
  __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_u_lower_class_limits, __pyx_t_6) < 0) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;

  /* "jenkspy/src/jenks.pyx":83
 *     return {
 *         "lower_class_limits": np.array(lower_class_limits),
 *         "variance_combinations": np.array(variance_combinations),             # <<<<<<<<<<<<<<
 *     }
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_array); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  ...
  __pyx_t_6 = (__pyx_t_5) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_5, __pyx_v_variance_combinations) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_v_variance_combinations);
  __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_u_variance_combinations, __pyx_t_6) < 0) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
  __Pyx_AddTraceback("jenkspy.jenks._jenks_matrices", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_lower_class_limits);
  __Pyx_XDECREF(__pyx_v_variance_combinations);
  __Pyx_XDECREF(__pyx_v_sorted_values);
  __PYX_XDEC_MEMVIEW(&__pyx_v__sorted_values, 1);
  __Pyx_XDECREF(__pyx_v_j);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_7jenkspy_5jenks_3_jenks_matrices(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7jenkspy_5jenks_3_jenks_matrices(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_values = 0;
  PyObject *__pyx_v_n_classes = 0;
  PyObject *__pyx_v_testing_algo = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_jenks_matrices (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_values,&__pyx_n_s_n_classes,&__pyx_n_s_testing_algo,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_classes)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_jenks_matrices", 0, 2, 3, 1); __PYX_ERR(0, 49, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_testing_algo);
          if (value) { values[2] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_jenks_matrices") < 0)) __PYX_ERR(0, 49, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_values = values[0];
    __pyx_v_n_classes = values[1];
    __pyx_v_testing_algo = values[2];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_jenks_matrices", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 49, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("jenkspy.jenks._jenks_matrices", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7jenkspy_5jenks_2_jenks_matrices(__pyx_self, __pyx_v_values, __pyx_v_n_classes, __pyx_v_testing_algo);
...
static PyObject *__pyx_pf_7jenkspy_5jenks_2_jenks_matrices(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_values, PyObject *__pyx_v_n_classes, PyObject *__pyx_v_testing_algo) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_7jenkspy_5jenks__jenks_matrices __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_jenks_matrices", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.testing_algo = __pyx_v_testing_algo;
  __pyx_t_1 = __pyx_f_7jenkspy_5jenks__jenks_matrices(__pyx_v_values, __pyx_v_n_classes, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "jenkspy.jenks.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "jenkspy.jenks._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_jenks_breaks", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7jenkspy_5jenks_1_jenks_breaks, METH_VARARGS|METH_KEYWORDS, 0},
  {"_jenks_matrices", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7jenkspy_5jenks_3_jenks_matrices, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_lower_class_limits, __pyx_k_lower_class_limits, sizeof(__pyx_k_lower_class_limits), 0, 1, 0, 1},
  ...
  {&__pyx_n_s_testing_algo, __pyx_k_testing_algo, sizeof(__pyx_k_testing_algo), 0, 0, 1, 1},
  {&__pyx_kp_s_unable_to_allocate_array_data, __pyx_k_unable_to_allocate_array_data, sizeof(__pyx_k_unable_to_allocate_array_data), 0, 0, 1, 0},
  {&__pyx_kp_s_unable_to_allocate_shape_and_str, __pyx_k_unable_to_allocate_shape_and_str, sizeof(__pyx_k_unable_to_allocate_shape_and_str), 0, 0, 1, 0},
  {&__pyx_n_s_unpack, __pyx_k_unpack, sizeof(__pyx_k_unpack), 0, 0, 1, 1},
  {&__pyx_n_s_update, __pyx_k_update, sizeof(__pyx_k_update), 0, 0, 1, 1},
  {&__pyx_n_s_values, __pyx_k_values, sizeof(__pyx_k_values), 0, 0, 1, 1},
  {&__pyx_n_u_variance_combinations, __pyx_k_variance_combinations, sizeof(__pyx_k_variance_combinations), 0, 1, 0, 1},
  {0, 0, 0, 0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_jenkspy__jenks) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "jenkspy.jenks")) {
      if (unlikely(PyDict_SetItemString(modules, "jenkspy.jenks", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init jenkspy.jenks", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init jenkspy.jenks");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
