...
class JenksClassTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.res5 = np.array([
            0, 2, 0, 3, 3, 3, 0, 2, 2, 0, 2, 0, 3, 1, 0, 3, 0, 2, 1, 0, 3, 0, 1, 1, 2, 
            0, 1, 3, 3, 0, 2, 0, 2, 1, 2, 0, 0, 0, 0, 0, 1, 3, 0, 0, 3, 2, 1, 3, 1, 0
            ])
        self.res6 = [
            np.array([
                132, 312, 113, 416, 359, 73, 245, 255, 253, 39, 327, 328, 301,
                96, 297, 179, 230, 1, 37, 230
            ]),
            np.array([
                658, 683, 654, 736, 583, 678, 767, 663, 679
            ]),
            np.array([
                915, 1028, 1078, 963, 848, 1079, 1083, 951, 927, 1009
            ]),
            np.array([
                1424, 1240, 1370, 1422, 1326, 1223, 1367, 1237, 1248, 1352, 1283
            ]),
        ]
